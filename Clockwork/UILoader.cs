    ...
    internal class UILoader
    {
        ...
        public static void LoadContent(ContentManager content, GraphicsDeviceManager graphics)
        {
            ...
            // -- Player Setup --
            {
                ...
                {
                    { "runBase", new Animation(0, 7, 12) },
                    { "walkBase", new Animation(8, 15, 6) },
                    { "idleBase", new Animation(16, 23, 6) },
                    { "jumpBase", new Animation(24, 24, 1) },
                    { "runHand", new Animation(25, 33, 12) },
                    { "walkHand", new Animation(33, 40, 6) },
                    { "idleHand", new Animation(41, 48, 6) },
                    { "jumpHand", new Animation(49, 49, 1) },
                    { "useHand", new Animation(50, 53, 12) },
                    { "runChime", new Animation(54, 61, 12) },
                    { "walkChime", new Animation(62, 69, 6) },
                    { "idleChime", new Animation(70, 77, 6) },
                    { "jumpChime", new Animation(78, 78, 1) },
                    { "useChime", new Animation(79, 82, 12) },
                    { "runGear", new Animation(83, 90, 12) },
                    { "walkGear", new Animation(91, 98, 6) },
                    { "idleGear", new Animation(99, 106, 6) },
                    { "jumpGear", new Animation(107, 107, 1) },
                    { "useGear", new Animation(108, 111, 12) },
                    { "runKey", new Animation(112, 119, 12) },
                    { "walkKey", new Animation(120, 127, 6) },
                    { "idleKey", new Animation(128, 135, 6) },
                    { "jumpKey", new Animation(136, 136, 1) },
                    { "useKey", new Animation(137, 143, 12) },
                    { "runFace", new Animation(144, 151, 12) },
